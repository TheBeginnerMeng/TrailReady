...
| 行程规划 | 装备库 | 打包清单 | 机甲主题 | 山野主题 |
|:---:|:---:|:---:|:---:|:---:|
| ![行程](screenshots/01-trip-planner.png) | ![装备](screenshots/02-gear-closet.png) | ![清单](screenshots/03-packing-list.png) | ![机甲](screenshots/04-theme-dark.png) | ![山野](screenshots/05-theme-nature.png) |
...
只需切换一个 **CSS 类名**，全局配色自动切换，无需暴力覆盖样式：
